...
import com.lala.shourya.pistachio.transverse.model.OAuthToken;
...
public class LoginActivity extends AppCompatActivity {
    ...
    **********************************************************/
     ...
     */
    private static final String CLIENT_ID = "1065817738380-lekvr5rlimqtbbarrkerjfiu4aq6d8ai.apps.googleusercontent.com";
    /**
     * The redirect uri you have define in your google console for your project
     */
    private static final String REDIRECT_URI = "com.lala.shourya.pistachio:/oauth2redirect";
    /**
     ...
     */
    private static final String REDIRECT_URI_ROOT = "com.lala.shourya.pistachio";
    /**
    ...
    public static final String API_SCOPE_GMAIL = "https://www.googleapis.com/auth/gmail.readonly";
    /**
        ...
        if (data != null && !TextUtils.isEmpty(data.getScheme())) {
            if (REDIRECT_URI_ROOT.equals(data.getScheme())) {
                ...
                if(!TextUtils.isEmpty(error)) {
                    ...
                    Toast.makeText(this, "There's some error babe",Toast.LENGTH_LONG).show();
            ...
            //else just launch your MainApplication
            else {
                Log.e(TAG, "onCreate: Token available, just launch MainApplication");
    ...
    private void makeAuthorizationRequest() {
        HttpUrl authorizeUrl = HttpUrl.parse("https://accounts.google.com/o/oauth2/v2/auth") //
                ...
                .addQueryParameter("scope", API_SCOPE_GMAIL)
